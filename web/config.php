    ...
    <div class="block">
      <div class="symfony-block-content">
        ...
        <?php if ($hasMajorProblems): ?>
          ...
          <p>Major problems have been detected and <strong>must</strong> be
            fixed before continuing:</p>
          <ol>
            <?php foreach ($majorProblems as $problem): ?>
              <li><?php echo $problem->getTestMessage() ?>
                <p class="help"><em><?php echo $problem->getHelpHtml() ?></em>
                </p>
              </li>
            <?php endforeach; ?>
          </ol>
        ...
        <?php if ($hasMinorProblems): ?>
          ...
          <p>
            <?php if ($hasMajorProblems): ?>Additionally, to<?php else: ?>To<?php endif; ?>
        ...
        <?php if (!$hasMajorProblems && !$hasMinorProblems): ?>
          <p class="ok">All checks passed successfully. Your system is ready to
